...
import { getAgreementsAllApi, getRefererApi, getModelsApi, getMatchAllApi, getHeadquartersAllApi, getAppointmentsApi, reportExamMonthly } from "../../api";
                    ...
                    <Grid item xs={1000}>
                      ...
                      <div style={{ width: "1150px" }} className="nav-tabla">
                        ...
                        <Grid container item xs={3.1} mt={1}>                          
                           <Grid container xs={9}>                          
                           <Button variant="contained" style={{ width: '40ch', height: '5.5ch', backgroundColor: "rgb(0 85 169)", color: "white", fontFamily: "Quicksand", fontWeight: "900", fontSize: "1.10rem" }}>Busca</Button> 
                           </Grid>
                        </Grid>
                        ...
                        <Grid  xs={2} mt={1}>                          
                           <Grid  xs={9}>                          
                           <Button variant="contained" style={{ width: '12ch', height: '5.5ch', backgroundColor: "rgb(0 85 169)", color: "white", fontFamily: "Quicksand", fontWeight: "900", fontSize: "1.10rem" }}>Limpiar</Button> 
                           </Grid>
                        </Grid>
